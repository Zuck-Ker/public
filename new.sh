...
echo $i" |"$cy"     TEAM HANZxREAL"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" YOAHI X HANZ"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku"YOSHI"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ALLAH SWT"$i"  |"
echo $i" |"$cy" THANKS TO FRIENDS"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 083175817046"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" ganz4you14@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
echo $i"|"$me" 1"$i" |"$cy" BRUTEFORCE FB PHP        "$i"|"$i"    |"$cy" B"$i" |"
echo $i"|"$me" 2"$i" |"$cy" BRUTEFORCE FB H4NZ   "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB yos    "$i"|"$i"    |"$cy" N"$i" |"
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" G"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N157G       "$i"|"$i"    |"$cy" K"$i" |"
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Zuck-Ker/hdr
cd hdrYS
...
sleep 2
echo $ku"WhatsApp :"$i" 6283175817046"
echo $ku"Facebook :"$i" YOSHI"
sleep 2
